...
@WebServlet("/che")
public class BalanceCheck extends GenericServlet
{
	...
	public void service(ServletRequest req, ServletResponse resp) throws ServletException, IOException {
		...
		String qry="select * from bank.info where Accountno=?";
		try {
		...
		out.println("<html><body bgcolor='red'><h1>details are: "+"<br>"+"Account no:"+accno+"<br>"+
